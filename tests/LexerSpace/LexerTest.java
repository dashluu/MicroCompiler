...
class LexerTest {
    ...
    public void testLexerValid1() {
        ...
        expectedTokens.add(new Token("52", TokenType.NUM));
        ...
        expectedTokens.add(new Token("-", TokenType.SUB));
        expectedTokens.add(new Token("25.0", TokenType.NUM));
        expectedTokens.add(new Token(")", TokenType.RPAREN));
        expectedTokens.add(new Token("-", TokenType.SUB));
        expectedTokens.add(new Token("(", TokenType.LPAREN));
        expectedTokens.add(new Token("32.4", TokenType.NUM));
        expectedTokens.add(new Token("-", TokenType.SUB));
        expectedTokens.add(new Token("+", TokenType.ADD));
        expectedTokens.add(new Token("0.0e0.0", TokenType.NUM));
        expectedTokens.add(new Token(")", TokenType.RPAREN));
        expectedTokens.add(new Token("/", TokenType.DIV));
        expectedTokens.add(new Token("0.9", TokenType.NUM));
        expectedTokens.add(new Token("*", TokenType.MULT));
        expectedTokens.add(new Token("0.0", TokenType.NUM));
    ...
    public void testLexerValid2() {
        ...
        expectedTokens.add(new Token("+", TokenType.ADD));
        expectedTokens.add(new Token("-", TokenType.SUB));
        expectedTokens.add(new Token("0.0e+0.5", TokenType.NUM));
        expectedTokens.add(new Token("*", TokenType.MULT));
        ...
        expectedTokens.add(new Token("(", TokenType.LPAREN));
        expectedTokens.add(new Token("(", TokenType.LPAREN));
        expectedTokens.add(new Token("2.0e-1", TokenType.NUM));
        expectedTokens.add(new Token("-", TokenType.SUB));
        expectedTokens.add(new Token("67.0", TokenType.NUM));
        expectedTokens.add(new Token("+", TokenType.ADD));
        expectedTokens.add(new Token("71e3", TokenType.NUM));
        expectedTokens.add(new Token("*", TokenType.MULT));
        expectedTokens.add(new Token("21", TokenType.NUM));
        expectedTokens.add(new Token(")", TokenType.RPAREN));
        expectedTokens.add(new Token(")", TokenType.RPAREN));
        expectedTokens.add(new Token(")", TokenType.RPAREN));
